# Casette — Sage-backed macOS calculator
#
# Quick start:
#   make           # debug-builds via SwiftPM into ./build/Casette.app
...
# App icon: regenerated when the script changes. The script renders a
# cassette tape at every macOS icon size and iconutil packages them.
