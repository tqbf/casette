// LIFTED VERBATIM from v0/09-sage-doctor/Sources/SageDoctor/DoctorReport.swift
// (the V0.9 `--json` report contract, frozen in plans/SAGE-DOCTOR.md as "the
// V1.10 boundary"). DO NOT refactor v0/09 — it is frozen evidence. The in-app
// Sage Doctor builds exactly this shape in-process and renders/copies it.
...
public struct ReportCandidate: Codable, Sendable, Equatable {
