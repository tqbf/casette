// LIFTED VERBATIM from v0/09-sage-doctor/Sources/SageDoctor/ReportFormatter.swift
// (the V0.9 human + `--json` renderings of the doctor report). DO NOT refactor
// v0/09 — it is frozen evidence. The in-app Doctor's "Copy Report" uses both.
