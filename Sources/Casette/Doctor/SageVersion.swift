// LIFTED VERBATIM from v0/09-sage-doctor/Sources/SageDoctor/SageVersion.swift
// (the V0.9 version parse + 9.5-floor policy, frozen in plans/SAGE-DOCTOR.md).
// DO NOT refactor v0/09 — it is frozen evidence.
