// LIFTED VERBATIM from v0/09-sage-doctor/Sources/SageDoctor/SageDiscovery.swift
// (the V0.9 priority search, frozen in plans/SAGE-DOCTOR.md). DO NOT refactor
// v0/09 — it is frozen evidence. V1.10 (in-app Sage Doctor) reuses this type.
