...
| [docs/COMPLETION-UI.md](docs/COMPLETION-UI.md) | Canonical completion UI contract: `ShellModel.draft` as source of truth, typed friendly IR, full-width hint lane layout, tape-reference preservation, and extension rules. |
