...
| [docs/COMPLETIONS-GUIDE.md](docs/COMPLETIONS-GUIDE.md) | The shipped completion vocabulary: every trigger/alias, accepted forms, chips, and Sage lowering for all 36 completions, plus the deliberately-deferred list. |
