...
Current gates are green: `make check`, `make test` (**285/285**, 47 suites), and `make build` passed at V1.10. Detailed historical notes live in [`progress/`](progress/), newest first. Hard-won bug lessons live in [`PROBLEMS.md`](PROBLEMS.md).
