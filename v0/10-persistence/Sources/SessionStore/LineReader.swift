// COPIED VERBATIM from v0/09-sage-doctor/Sources/SageDoctor/LineReader.swift
// (the proven single-producer/single-consumer reader). DO NOT refactor v0/09.
// V1 should unify with v0/09's copy. See plans/SESSION-FORMAT.md.
