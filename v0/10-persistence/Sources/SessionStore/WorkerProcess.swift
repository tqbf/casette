// COPIED VERBATIM from v0/09-sage-doctor/Sources/SageDoctor/WorkerProcess.swift
// (the proven Swift process-control pattern). DO NOT refactor v0/09 — it is
// frozen evidence. V1 should UNIFY this with v0/09's copy into one SageKernel.
// See plans/SESSION-FORMAT.md "V1 integration notes".
